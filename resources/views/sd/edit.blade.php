                    ...
                    <form action="/sd/{{$sd->id}}" method="POST">
                        ...
                        @csrf 
                            <div class="form-group" align="left">
                                ...
                                <input type="text" class="form-control" align="left" name="event" id="event" placeholder="Name of Event" style="background-color:rgb(26, 45, 60)" value="{{$sd->event}}">
                            </div>
                            <div class="form-group" align="left">
                                <label for="time">Time</label>
                                <input type="datetime-local" class="form-control" align="left" name="time" id="time" placeholder="Time of Event" style="background-color:rgb(26, 45, 60)" value="{{$sd->time}}">
                            </div>
                            <div class="form-group" align="left">
                                <label for="original">Original Speech Result</label>
                                <textarea class="form-control" align="left" type="text-area" name="original" id="original" placeholder="Original Speech"  style="min-height:150px; background-color:rgb(26, 45, 60)" disabled> {{$sd->original}} </textarea>
                            </div>
                            <div class="form-group" align="left">
