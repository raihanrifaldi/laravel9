    ...
    <div class="content-header mb-5 mt-3">
        <div class="container-fluid">
            <div class="mb-2">
                <div class="col-sm-8">
                    <h1>
                        Speaker Diarization Table Page
                    </h1>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="card" style="width:1050px; background-color:#0B0F19;  border-radius:0.5cm" align="left" >
                ...
                <div class="card-body" style="padding:30px"> 
                            ...
                            @foreach($sd as $s)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="/sd/{{$s->id}}/detail" style="color:rgb(83, 240, 83)">Details</a>
                                    </td>
                                    <td>
                                        <i class="icon-note" style="color:yellow"></i>
                                        <a href="/sd/{{$s->id}}/edit" style="color:yellow">Edit</a>
                                    </td>
                                    <td>
                                        {{-- <form action="/sd/{{ $s->id }}" method="POST"> 
                                            @csrf
                                            @method('delete')
                    ...
                    @endif
                        <div class="mt-3">
                            {{$sd->withQueryString()->links('pagination::bootstrap-5')}}
                        </div>
                    </div>
                </div>
            </div>
