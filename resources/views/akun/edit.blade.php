                                ...
                                <div class="flexing" style="margin-top:0px">
                                    ...
                                    <div class="user_detail" align="left"> 
                                        ...
                                        {{-- <div class="form-group">
                                            ...
                                            {{-- <input class="form-control" type="text" name="level" id="level" placeholder="Level" value="{{$akun->level}}" style="visibility: hidden"> --}}
                                        {{-- </div> --}}
                                        <div class="form-group">
                                            <label for="password">Level</label>
                                            <input class="form-control" type="text" name="level" id="level" placeholder="Level" style="background-color:rgb(26, 45, 60)" value="{{$akun->level}}">
                                        </div>
