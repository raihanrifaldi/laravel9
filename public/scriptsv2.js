// const talkingBtn = document.querySelector(".talking"),
...
//     recognition.stop();
//     talkingBtn.querySelector("p").innerHTML = "Start Listening";
//     talkingBtn.classList.remove("recording");
//     recording = false;
// }
